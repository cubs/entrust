...
1) In order to install Laravel Entrust, just add the following to your composer.json. Then run `composer update`:

Under `require`:
```json
"zizaco/entrust": "dev-feature/support_newer_laravel_versions"
```
...
"entrust": {
  "type": "vcs",
  "url": "https://github.com/cubs/entrust"
},
```
